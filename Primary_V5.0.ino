...
void startDelayTimer(int tankId, int minutes) {
    ...
    queueSlackMessage("Tank" + String(tankId) + " has timed open enabled for " + String(minutes) + " minutes");
...
void sendSleepCommand(int tankId, int minutes) {
    ...
    queueSlackMessage("Tank" + String(tankId) + " has gone into low power sleep for " + String(minutes) + " minutes");
}
